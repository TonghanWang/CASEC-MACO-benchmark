...
class BasicMAC:
    ...
    def forward(self, ep_batch, t, test_mode=False):
        ...
        # (bs,n,a_actions), (bs,n,hidden_dim) = (bs*n,(obs+act+id)), (bs,n,hidden_dim)
    ...
    def init_hidden(self, batch_size):
        self.hidden_states = self.agent.init_hidden().unsqueeze(0).expand(batch_size, self.n_agents, -1)  # (b, n, actions)
